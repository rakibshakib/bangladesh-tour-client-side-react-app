...
const TourPackages = () => {
    ...
    return (
        <div className='container mx-auto'>
            ...
            <p className='text-center font-base text-md py-2'>Whether you are looking for a sightseeing tour, a photography tour, archaeological tour or a nature tour, we have you covered with these exciting day tours.</p>
            <hr />
            ...
            <Link to='/allpackages'>
                <h2 className='border font-semibold rounded-2xl text-center py-3 mx-auto my-5 w-1/4 hover:bg-green-700 hover:text-white text-green-700 transition delay-75 duration-300 ease-in-out'>
                    See All Packages
                </h2>
            </Link>
        </div>
